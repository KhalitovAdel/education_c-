...
namespace sf.Controllers
{
    public class TournamentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TournamentId,TournamentName,StartDate,EndDate,Location,Format,NumberOfTeams,PrizeMoney,Organizer,Sponsor,Website")] Tournament tournament)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TournamentId,TournamentName,StartDate,EndDate,Location,Format,NumberOfTeams,PrizeMoney,Organizer,Sponsor,Website")] Tournament tournament)
        {
